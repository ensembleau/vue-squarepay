...
export default {
        ...
        href() {
            const data = {
                ...
                'S.com.squareup.register.TENDER_TYPES': [
                    `com.squareup.register. + this.tenderTypes.card`,
                    `com.squareup.register. + this.tenderTypes.cardOnFile`,
                    `com.squareup.register. + this.tenderTypes.cash`,
    ...
    props: {
        ...
        tenderTypes: [card, cardOnFile, cash, other]
    },
}
</script>
...
<div class="button-wrapper">
    <a class="square-pay-button" :href="href">
        <slot></slot>
    </a>
</div>
</template>
